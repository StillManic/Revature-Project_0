...
public class MockDB {
	...
	static {
		...
		customers.put(1, new Customer(1, "batman", "robin"));
		customers.put(2, new Customer(2, "neva", "river"));
		customers.put(3, new Customer(3, "lesly", "lesly"));
		customers.put(4, new Customer(4, "jason", "jiu_jitsu"));
		
		accounts.put(1, new Account(1, 8000000));
		accounts.put(2, new Account(2, 25000));
		accounts.put(3, new Account(3, 100000));
